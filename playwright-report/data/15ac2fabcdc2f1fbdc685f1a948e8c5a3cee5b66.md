...
- Name: auth.spec.ts >> Authentication >> should allow user to register and login
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    5 × locator resolved to <html lang="en" class="__variable_246ccd __variable_c29908 h-full antialiased">…</html>
...
```yaml
- text: Criar Conta Cadastre-se para começar a gerenciar suas finanças. Nome
- textbox "Nome"
- text: Email
- textbox "Email"
- text: Senha

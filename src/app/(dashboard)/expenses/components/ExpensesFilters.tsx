...
export function ExpensesFilters({ periods, categories, selectedPeriodId }: ExpensesFiltersProps) {
    ...
    <div className="flex flex-col md:flex-row gap-4 items-center">
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-4 w-full md:w-auto">
        <Select 
          ...
          onValueChange={(val) => router.push(`?${createQueryString('periodId', val)}`)}
        >
        ...
        <Select 
          ...
          onValueChange={(val) => router.push(`?${createQueryString('category', val === 'all' ? '' : val)}`)}
        >
